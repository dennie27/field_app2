...
class CProfile extends StatefulWidget {
  ...
  final  client;
  final angaza;
  const CProfile({Key? key, required this.id,required this.client,required this.angaza}) : super(key: key);
      ...
      body: SingleChildScrollView(
        child:Column(
          children: [
            ...
            StreamBuilder(
              stream:
              firestore.collection("new_calling").doc(widget.id).snapshots(),
